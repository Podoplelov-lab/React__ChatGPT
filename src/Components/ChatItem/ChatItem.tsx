...
export default function ChatItem({ title, handleDeleteChat, id, selectChat }: { title: string, handleDeleteChat: (value: string) => void, id: string, selectChat: (value: string) => void }) {
    return (
